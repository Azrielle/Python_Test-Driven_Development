...
class ListViewTest( TestCase ):
	...
	def test_dublicate_item_validation_errors_end_up_on_lists_page(self):
		'''тест: ошибки валидации повторяющегося элемента
		   оканчиваются на странице списка'''
...
class MyListsTest(TestCase):
	...
	def test_passes_correct_owner_to_template(self):
		'''тест: передается правельный владелец в шаблон'''
...
class NewListViewUnitTest(unittest.TestCase):
	...
	def test_seves_form_with_owner_if_form_valid(self, mockNewListForm):
	...
	def test_redirects_to_form_returned_object_if_form_valid(
		...
		'''тест: переадремует в возвращаемый формой обьект,
